...
export const ShippingForm = ()=>{ 
    ...
    return(
        <div className='Shipping-box'>
               ...
               <input className='input' placeholder="FIRST NAME"  style={{marginRight:"30px", border:"none", marginTop:"20px", width:"270px"}} name="FirstName" onChange={handlechange} required />
               <input className='input' placeholder="LAST NAME"  style={{marginTop:"20px",width:"270px"}} name="LastName" onChange={handlechange} required/> <br />
               <input className='input' placeholder="C/O"  style={{marginRight:"30px", border:"none", marginTop:"20px", width:"270px"}} name="CO" onChange={handlechange} required />
               <input className='input' placeholder="TELEPHONE"  type="number" style={{marginTop:"20px",width:"270px"}} name="PhoneNumber" onChange={handlechange} required /> <br />
               <input className='input' placeholder="STREET NAME AND NUMBER"  style={{marginRight:"30px", border:"none", marginTop:"20px", width:"270px"}} name="StreetName" onChange={handlechange} required  />
               <input className='input' placeholder="ZIP CODE"  type="number" style={{marginTop:"20px",width:"270px"}} name="ZipCode" onChange={handlechange} required /> <br />
               <input className='input' placeholder="CITY"  style={{marginRight:"30px", border:"none", marginTop:"20px", width:"270px"}} name="City" onChange={handlechange} required/> 
               <input className='input' placeholder="STATE/PROVINCE"  style={{marginTop:"20px",width:"270px"}} name="State" onChange={handlechange} required/> <br />
               <input className='input' placeholder="COUNTRY"  style={{marginTop:"20px",width:"270px"}} name="Country" onChange={handlechange} required /> <br />
