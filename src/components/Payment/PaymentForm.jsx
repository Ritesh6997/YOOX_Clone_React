  ...
  const fire = useCallback(() => {
    ...
    return (
      <div className="shippingBox">
        ...
        >
          <div className="shippingSubTitles">
            <input type="radio" name="" id="" />
            Credit Card
          </div>
          <div style={{ display: "flex" }}>
            <img
              className="creditCardImages"
              src="https://www.yoox.com/media/yoox/apps/yoox-checkout/payment/credit-cards/img_payment_Visa.png"
              alt=""
            />
            <img
              className="creditCardImages"
              src="https://www.yoox.com/media/yoox/apps/yoox-checkout/payment/credit-cards/img_payment_mastercard.png"
              alt=""
            />
            <img
              className="creditCardImages"
              src="https://www.yoox.com/media/yoox/apps/yoox-checkout/payment/credit-cards/img_payment_amex.png"
              alt=""
            />
            <img
              className="creditCardImages"
              src="https://www.yoox.com/media/yoox/apps/yoox-checkout/payment/credit-cards/img_payment_JCB.png"
              alt=""
            />
          </div>
